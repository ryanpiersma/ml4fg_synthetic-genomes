#This script adapted from https://gitlab.inria.fr/ml_genetics/public/artificial_genomes/-/tree/master/
#where it was used for human genomes! GAN architecture is preserved, but parameters like learning rate are
#tweaked for usage with Arabidopsis thaliana
...
inpt = "arabidopsis_10k_sampled.hapt" #hapt format input file
latent_size = 600 #size of noise input
alph = 0.01 #alpha value for LeakyReLU
g_learn = 0.00001 #generator learning rate
d_learn = 0.00008 #discriminator learning rate
epochs = 20001
batch_size = 32
ag_size = 100 #number of artificial genomes (haplotypes) to be created
...
for e in range(epochs):
    ...
    if e%save_that == 0 or e == epochs:
        ...
        print("generated genomes df shape " + str(generated_genomes_df.shape[1]))
